...
void controlMixer() {
  ...
  //Cylic Responce Motor Commands
  m1_command_scaled = thro_des + (pitch_PID * cos(rads)) + (roll_PID * sin(rads)); // Main motor cyclic applied torque 
  m2_command_scaled = thro_des + yaw_PID; // Tail rotor responisbile for yaw
  m3_command_scaled = 0;
  m4_command_scaled = 0;
  m5_command_scaled = 0;
  m6_command_scaled = 0;
...
void getCommands() {
   ...
   */
    ...
    channel_1_pwm = getRadioPWM(2);
    channel_2_pwm = getRadioPWM(1);
